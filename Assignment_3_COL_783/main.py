...
def fast_enlarge(myImage,colLevels,colSize,rowLevels,rowSize):
    img = copy.deepcopy(myImage)
    print("Fast Enlarging Column...")
    fastEnlargedImageCol = enlargeColumnsFast(img,colLevels,colSize)
    rowsE,columnsE = fastEnlargedImageCol.shape[0:2]
    print("Rows : ",rowsE,"Columns : ",columnsE)

    print("Fast Enlarging Row...")
    rImage = rotate_image(fastEnlargedImageCol,0)
    fastEnlargedImageRow = enlargeColumnsFast(rImage,rowLevels,rowSize)
...
cv2.imwrite('/content/drive/MyDrive/COL783/fastseamenlarge.jpg',fastImage)
